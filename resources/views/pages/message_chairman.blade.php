...
<div class="flex flex-col md:flex-row items-center gap-12 mb-20">
  <div class="w-full md:w-1/2 relative group">
    <div
      class="absolute -inset-4 bg-saffron/20 blur-xl rounded-full opacity-50 group-hover:opacity-100 transition duration-1000"></div>
    <div
      class="relative bg-stone-900 p-2 rounded-2xl border border-stone-800 shadow-2xl">
      <img
        src="{{ asset('images/chairman.jpeg') }}"
        alt="Project director Message"
  ...
  <div class="w-full md:w-1/2">
    ...
    <div class="mt-6">
      <span class="  text-lg font-bold text-accent">HG Vaikunthapati Das</span>
  ...
  <div
    ...
    <ul class="space-y-6 font-semibold">
      <li class="flex flex-col">
        <span class="text-[10px] uppercase opacity-70 mb-1">Phase 1</span>
        Land Acquisition
      </li>
      <li class="flex flex-col">
        <span class="text-[10px] uppercase opacity-70 mb-1">Community</span>
        Extablishing a Preaching Center
      </li>
      <li class="flex flex-col">
        <span class="text-[10px] uppercase opacity-70 mb-1">Education</span>
        Bhaktivedanta Library
      </li>
      <li class="flex flex-col">
        <span class="text-[10px] uppercase opacity-70 mb-1">Outreach</span>
    ...
    <div
      ...
      <div>
        ...
        <div class="flex items-center gap-4 mt-4">
          ...
          <span
            class="font-bold text-white uppercase tracking-wider text-sm">Service • Devotion • Culture</span>
        </div>
      </div>

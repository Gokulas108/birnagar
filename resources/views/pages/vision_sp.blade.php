    ...
    <div class="max-w-3xl mx-auto px-6 text-center">
        <div class="relative py-10 pb-0">
            ...
            <!-- <button class="bg-saffron-500 text-orange-50 px-8 py-3 rounded-full font-semibold hover:bg-amber-800 transition shadow-lg hover:shadow-orange-600/20">
                <a href="/campaign" class="bg-saffron-500 text-orange-50 px-8 py-3 rounded-full font-semibold hover:bg-amber-800 transition shadow-lg hover:shadow-orange-600/20 inline-block">
                    Support the Vision
                </a>

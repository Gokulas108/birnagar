...
<div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
  <div
    ...
    <div
      class="absolute -right-10 -top-10 w-40 h-40 bg-saffron-500/10 rounded-full group-hover:scale-150 transition-transform duration-700"></div>
...
<div
  ...
  <div
    ...
    <i
      class="fas fa-globe-asia text-[20rem] absolute -right-20 -bottom-20 rotate-12"></i>
  </div>

      ...
      <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-10 md:gap-12 mb-12 sm:mb-14 md:mb-16">
          ...
          <div class="md:col-span-1 text-center md:text-left">
            ...
            <p class="text-sm leading-relaxed text-stone-400 mb-5 sm:mb-6">
              Dedicated to the lotus feet of Srila Bhaktivinoda Thakur and Srila
              Prabhupada.
            </p>
            <!-- Social Links -->
          ...
          <div class="text-center md:text-left">
            ...
            <ul class="space-y-1 sm:space-y-3">
              <li>
                <a href="#about" class="text-stone-400 hover:text-saffron-500 transition-colors duration-300 inline-block"
                  >Our History</a
                >
              </li>
              <li>
                <a href="#events" class="text-stone-400 hover:text-saffron-500 transition-colors duration-300 inline-block"
                  >Festival Calendar</a
                >
              </li>
              <li>
                <a href="#songs" class="text-stone-400 hover:text-saffron-500 transition-colors duration-300 inline-block"
                  >Vaishnava Songs</a
                >
              </li>
              <li>
          ...
          <div class="text-center md:text-left">
            ...
            <p class="text-stone-500 text-sm mb-3 sm:mb-4">Subscribe for updates on festivals and events.</p>
            <form class="flex flex-col gap-3">
              <input
                type="email"
                placeholder="Your email address"
                required
                class="bg-stone-800 border border-stone-700 rounded-lg p-3 text-white placeholder-stone-500 focus:outline-none focus:border-saffron-500 focus:ring-2 focus:ring-saffron-500/30 transition-all text-sm"
              />
              <button
                type="submit"
                class="bg-gradient-to-r from-saffron-500 to-orange-500 text-white font-semibold py-2.5 rounded-lg hover:shadow-lg hover:shadow-saffron-500/50 transition-all duration-300 transform hover:scale-105 active:scale-95"
              >
                Subscribe
              </button>
            </form>

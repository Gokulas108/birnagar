        ...
        <div class="flex flex-col items-center">
          <div class="relative">
            ...
            <div class="relative bg-orange-100/40 backdrop-blur-md border border-orange-400/30 rounded-lg px-3 py-2 sm:px-5 sm:py-3.5 md:px-6 md:py-4 lg:px-8 lg:py-6">
              <span
                id="days"
                class="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-mono font-bold tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-orange-500 to-orange-700">000</span>
            </div>
          </div>
        ...
        <div class="flex flex-col items-center">
          <div class="relative">
            ...
            <div class="relative bg-orange-100/40 backdrop-blur-md border border-orange-400/30 rounded-lg px-3 py-2 sm:px-5 sm:py-3.5 md:px-6 md:py-4 lg:px-8 lg:py-6">
              <span
                id="hours"
                class="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-mono font-bold tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-orange-500 to-orange-700">00</span>
            </div>
          </div>
        ...
        <div class="flex flex-col items-center">
          <div class="relative">
            ...
            <div class="relative bg-stone-900/60 backdrop-blur-md border border-cyan-400/30 rounded-lg px-3 py-2 sm:px-5 sm:py-3.5 md:px-6 md:py-4 lg:px-8 lg:py-6">
              <span
                id="seconds"
                class="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-mono font-bold tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-cyan-300 to-cyan-500">00</span>
            </div>
          </div>

    ...
    <div class="animate-slide-up">
      <div
        ...
        <div class="status-success px-6 py-8 md:px-12 md:py-12 text-center relative overflow-hidden">
          <div
            class="absolute top-0 right-0 w-40 h-40 bg-white/10 rounded-full -mr-20 -mt-20 blur-2xl"></div>
          ...
          <div class="space-y-6">
            ...
            <div class="space-y-3">
              ...
              <p class="text-sm text-stone-600">
                ...
                <span>If the problem persists, please contact our support team at
                  <span class="font-semibold">sbvt.jsp@gmail.com</span></span>
              </p>
            </div>
